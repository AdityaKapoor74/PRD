...
class A2CAgent:
	...
	def __init__(
		...
		self.critic_network = SemiHardNormalizedAttentionTransformerCritic(obs_dim, 128, obs_dim+self.num_actions, 128, 128, 1, self.num_agents, self.num_actions).to(self.device)
