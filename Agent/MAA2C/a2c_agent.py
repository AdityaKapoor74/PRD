...
class A2CAgent:
	...
	def __init__(
		...
		self.critic_network = SemiHardGATCritic(obs_dim, 128, obs_dim+self.num_actions, 128, 128, 1, self.num_agents, self.num_actions, weight_threshold=0.03).to(self.device)
