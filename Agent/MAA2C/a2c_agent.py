...
class A2CAgent:
	...
	def __init__(
		...
		self.critic_network = SemiHardMultiHeadGATV2Critic(obs_dim, 128, obs_dim+self.num_actions, 128, 128, 1, self.num_agents, self.num_actions, kth_weight=8, num_heads=4).to(self.device)
