...
if __name__ == '__main__':
	...
	for i in range(1,2):
		extension = "run"+str(i)
		test_num = "NormalizedATTests" #TransformersTest
		...
		dictionary = {
				...
				"critic_type": "SemiHardMultiHeadNormalizedAttentionTransformerCritic", # TransformersONLY/ GATONLY/ GATv2ONLY/ NormalizedATONLY/ else One Critic for training
