...
if __name__ == '__main__':
	...
	for i in range(1,2):
		...
		dictionary = {
				...
				"critic_type": "MultiHeadSemiHardAttnTransformerCriticweightthreshold0.03", # TransformersONLY/ GATONLY/ GATv2ONLY/ NormalizedATONLY/ else One Critic for training
