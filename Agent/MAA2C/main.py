...
if __name__ == '__main__':
	...
	# 			"test_num":test_num,
	# 			"value_lr": 1e-3, 
	# 			"policy_lr": 4e-5, # 5e-4(shared) 8e-5(prd_above_threshold_ascend)
	# 			"entropy_pen": 8e-3, 
	...
	for i in range(1,2):
		extension = "run"+str(i)
		test_num = "crossing_partially_coop_32_agents" #crossing_8_agents_pen_non_colliding_agents_policy_eval
