...
if __name__ == '__main__':
	...
	# for i in range(1,6):
		...
		# experiment_type = "prd_above_threshold_l1_pen_transpose" # prd_above_threshold_decay, greedy, shared, prd_above_threshold_ascend, prd_above_threshold_l1_pen_decay
	...
	for i in range(1,6):
		...
		env_name = "crossing"
		experiment_type = "prd_above_threshold_l1_pen_transpose" # prd_above_threshold_decay_episodic, greedy, shared
