...
if __name__ == '__main__':
	...
	for i in range(1,4):
		...
		experiment_type = "prd_soft_advantage_ascend" # shared, prd_above_threshold_ascend, prd_above_threshold, prd_top_k, prd_above_threshold_decay, prd_soft_advantage prd_soft_advantage_global, HAPPO
