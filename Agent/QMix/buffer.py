...
class ReplayMemory:
	...
	# push once per step
	def push(self, state, actions, last_one_hot_actions, next_state, next_last_one_hot_actions, next_mask_actions, reward, done):
	...
	def sample(self, num_episodes):
		...
		return state_batch, actions_batch, last_one_hot_actions_batch, next_state_batch, next_last_one_hot_actions_batch, next_mask_actions, reward_batch, done_batch, mask_batch, max_episode_len
