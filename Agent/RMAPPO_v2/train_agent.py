...
if __name__ == '__main__':
	...
	for i in range(1,4):
		...
		test_num = "StarCraft"
		env_name = "10m_vs_11m"
		experiment_type = "prd_top_k" # shared, prd_above_threshold_ascend, prd_above_threshold, prd_top_k, prd_above_threshold_decay, prd_soft_advantage
		...
		dictionary = {
				...
				"steps_to_take": 1000,
				"top_k": 5, # 3 (5m_vs_6m), 5 (10m_vs_11m), 4 (3s5z)
				"norm_adv": True,
