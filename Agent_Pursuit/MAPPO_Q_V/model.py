...
class MLP_Policy(nn.Module):
	def __init__(self, height, width, in_channel, num_actions, num_agents, device):
...
class Q_network(nn.Module):
	def __init__(self, height, width, in_channel, num_heads, num_agents, num_actions, device, enable_hard_attention):
