...
class COMAAgent:
	...
	def update(self, state_agents, state_opponents, next_state_agents, next_state_opponents, one_hot_actions, one_hot_next_actions, actions, rewards, dones, episode):
		...
		Q_values, weights_value = self.critic_network(state_agents, state_opponents, probs.detach(), one_hot_actions)
		...
		target_Q_values, target_weights_value = self.target_critic_network(state_agents, state_opponents, probs.detach(), one_hot_actions)
