...
from a2c_model_traffic_junc import *
...
class A2CAgent:
	...
	def calculate_value_loss(self, V_values, target_V_values, rewards, dones, weights, next_states_critic, next_states_actor, one_hot_next_actions):
	...
	def update(self,states_critic,next_states_critic,one_hot_actions,one_hot_next_actions,actions,states_actor,next_states_actor,rewards,dones,episode):
		...
		Calculate V values
		'''
		V_values, weights_value = self.critic_network(states_critic, probs.detach(), one_hot_actions)
		...
		discounted_rewards, next_probs, value_loss = self.calculate_value_loss(V_values, target_V_values, rewards, dones, weights_value, next_states_critic, next_states_actor, one_hot_next_actions)
