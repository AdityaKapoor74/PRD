...
if __name__ == '__main__':
	...
	for i in range(1,2):
		...
		dictionary = {
				...
				"gif_checkpoint":1,
				"load_models": True,
				"model_path_value": "../../../tests/PRD_PRESSURE_PLATE/models/pressureplate-linear-4p-v0_prd_above_threshold_MAPPO_Q_run_1/critic_networks/critic_epsiode2000.pt",
				"model_path_policy": "../../../tests/PRD_PRESSURE_PLATE/models/pressureplate-linear-4p-v0_prd_above_threshold_MAPPO_Q_run_1/actor_networks/actor_epsiode2000.pt",
				"eval_policy": False,
				"save_model": False,
