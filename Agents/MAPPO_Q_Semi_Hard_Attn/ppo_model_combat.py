...
class RolloutBuffer:
	def __init__(self):
		self.shared_states = []
		self.shared_probs = []
		self.shared_logprobs = []
		self.shared_actions = []
		self.shared_one_hot_actions = []
		self.shared_rewards = []
		self.shared_dones = []
		...
		self.prd_logprobs = []
		self.prd_actions = []
		self.prd_one_hot_actions = []
		self.prd_rewards = []
		self.prd_dones = []
	

	def clear(self):
		del self.shared_states[:]
		del self.shared_probs[:]
		del self.shared_logprobs[:]
		del self.shared_actions[:]
		del self.shared_one_hot_actions[:]
		del self.shared_rewards[:]
		del self.shared_dones[:]

		del self.prd_states[:]
		del self.prd_probs[:]
		del self.prd_logprobs[:]
		del self.prd_actions[:]
		del self.prd_one_hot_actions[:]
		del self.prd_rewards[:]
		del self.prd_dones[:]
