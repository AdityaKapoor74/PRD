...
if __name__ == '__main__':
	...
	# GRAD VAR EXPERIMENT
	# episode_list = [str(6000*(i+1)) for i in range(20)]
	...
	# try: 
	# 	os.makedirs("../../../tests/Combat/grad_var/", exist_ok = True) 
	...
	# 			"gif_checkpoint":1,
	# 			"load_models": False,
	# 			"model_path_value": "../../../tests/Combat/models/ma_gym:Combat-v0_prd_above_threshold_MAPPO_Q_run_1/critic_networks/critic_epsiode"+episode+".pt",
	# 			"model_path_policy": "../../../tests/Combat/models/ma_gym:Combat-v0_prd_above_threshold_MAPPO_Q_run_1/actor_networks/actor_epsiode"+episode+".pt",
	# 			"eval_policy": False,
	# 			"save_model": False,
	# 			"save_model_checkpoint": 1000,
	...
	# 	np.save("../../../tests/Combat/grad_var/grad_vars_"+experiment_type+"_"+env_name,np.array(grad_vars))
	# 	np.save("../../../tests/Combat/grad_var/grad_stds_"+experiment_type+"_"+env_name,np.array(grad_vars))
