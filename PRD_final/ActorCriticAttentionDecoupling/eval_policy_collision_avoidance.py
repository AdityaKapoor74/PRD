...
def run(env, max_episodes, max_steps):  
	...
	policy_eval_dir = '../../../policy_eval/collision_avoidance/ScalarDotProductPolicyNetwork/'
	try: 
	...
	for run in runs:
		for experiment in experiment_type:
			...
			# FOR REMOTE SYSTEM
			model_dir_policy = "../../../all_models/models/"+run+"/models/Scalar_dot_product/collision_avoidance/6_Agents/SingleAttentionMechanism/" + experiment + "/actor_networks/"
