...
def run(env, max_episodes, max_steps):  
	...
	policy_eval_dir = '../../../policy_eval/paired_by_sharing_goals/ScalarDotProductPolicyNetwork/'
	try: 
	...
	for run in runs:
		...
		for experiment in experiment_type:
			...
			# FOR REMOTE SYSTEM
			model_dir_policy = "../../../all_models/models/"+run+"/models/Scalar_dot_product/paired_by_sharing_goals/10_Agents/SingleAttentionMechanism/" + experiment + "/actor_networks/"
