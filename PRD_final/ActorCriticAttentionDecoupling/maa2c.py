...
class MAA2C:
	...
	def __init__(self,env, gif=True, save=True):
		...
		if not(self.gif) and self.save:
			critic_dir = '../../../models/Scalar_dot_product/Environment1/4_Agents/Experiment_summed_value_loss_without_mask/critic_networks/'
			try: 
				os.makedirs(critic_dir, exist_ok = True) 
				print("Critic Directory created successfully") 
			except OSError as error: 
				print("Critic Directory can not be created") 
			actor_dir = '../../../models/Scalar_dot_product/Environment1/4_Agents/Experiment_summed_value_loss_without_mask/actor_networks/'
			try: 
				os.makedirs(actor_dir, exist_ok = True) 
				print("Actor Directory created successfully") 
			except OSError as error: 
				print("Actor Directory can not be created")  
			weight_dir = '../../../weights/Scalar_dot_product/Environment1/4_Agents/Experiment_summed_value_loss_without_mask/'
			try: 
			...
			tensorboard_dir = '../../../runs/Scalar_dot_product/Environment1/4_Agents/Experiment_summed_value_loss_without_mask/'
			...
			gif_dir = '../../../gifs/Scalar_dot_product/Environment1/4_Agents/Experiment_summed_value_loss_without_mask/'
			try: 
