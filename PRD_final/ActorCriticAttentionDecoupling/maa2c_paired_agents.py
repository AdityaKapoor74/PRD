...
class MAA2C:
	...
	def update(self,trajectory,episode):
		...
		if not(self.gif) and self.save:
			...
			experiment.log_metric('Average_Weights_paired',paired_agent_avg_weight,episode)
			experiment.log_metric('Average_Weights_unpaired',unpaired_agent_avg_weight,episode)
