...
class MAA2C:
	...
	def __init__(self,env, gif=True, save=True):
		...
		if not(self.gif) and self.save:
			critic_dir = '../../../models/Scalar_dot_product/paired_by_sharing_goals/8_Agents/SingleAttentionMechanism/without_prd/critic_networks/'
			try: 
				os.makedirs(critic_dir, exist_ok = True) 
				print("Critic Directory created successfully") 
			except OSError as error: 
				print("Critic Directory can not be created") 
			actor_dir = '../../../models/Scalar_dot_product/paired_by_sharing_goals/8_Agents/SingleAttentionMechanism/without_prd/actor_networks/'
			try: 
				os.makedirs(actor_dir, exist_ok = True) 
				print("Actor Directory created successfully") 
			except OSError as error: 
				print("Actor Directory can not be created")  
			weight_dir = '../../../weights/Scalar_dot_product/paired_by_sharing_goals/8_Agents/SingleAttentionMechanism/without_prd/'
			try: 
			...
			tensorboard_dir = '../../../runs/Scalar_dot_product/paired_by_sharing_goals/8_Agents/SingleAttentionMechanism/without_prd/'
			...
			gif_dir = '../../../gifs/Scalar_dot_product/paired_by_sharing_goals/8_Agents/SingleAttentionMechanism/without_prd/'
			try: 
