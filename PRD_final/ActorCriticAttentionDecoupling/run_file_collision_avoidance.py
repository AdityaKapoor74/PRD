...
if __name__ == '__main__':
	...
	for i in range(len(env_list)):
		for j in range(len(experiment_type)):
			dictionary = {
			"critic_dir": '../../../collision_avoidance_no_collision_pen_10_Agents/models/'+experiment_type[j]+'/critic_networks/',
			"actor_dir": '../../../collision_avoidance_no_collision_pen_10_Agents/models/'+experiment_type[j]+'/actor_networks/',
			"tensorboard_dir":'../../../collision_avoidance_no_collision_pen_10_Agents/runs/'+experiment_type[j]+'/',
			"gif_dir": '../../../collision_avoidance_no_collision_pen_10_Agents/gifs/'+experiment_type[j]+'/',
			"env": env_list[i], 
