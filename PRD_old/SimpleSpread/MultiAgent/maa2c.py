...
#       make a directory called models
      if episode%500:
        torch.save(self.agents.actorcritic.state_dict(), "./models/four_agents/actorcritic_network_no_comms_discounted_rewards_smaller_agents_wo_termination_0.05_lr_2e-4_with_grad_norm_0.5_entropy_pen_0.008_xavier_uniform_init_clamp_logs.pt")
