...
class MAA2C:
  ...
  def __init__(self,env,gif=True):
    ...
    if not(self.gif):
      ...
      # Separate network
      self.writer = SummaryWriter('../../runs/separate_net/4_agents/value_lr_2e-4_policy_lr_2e-4_entropy_0.008_conditioning_on_action_number')
      # # Shared network
...
#         # Separate networks
        torch.save(self.agents.value_network.state_dict(), "../../models/separate_net/4_agents/value_net_lr_2e-4_policy_lr_2e-4_with_grad_norm_0.5_entropy_pen_0.008_xavier_uniform_init_clamp_logs_conditioning_on_action_number.pt")
        torch.save(self.agents.policy_network.state_dict(), "../../models/separate_net/4_agents/policy_net_lr_2e-4_value_lr_2e-4_with_grad_norm_0.5_entropy_pen_0.008_xavier_uniform_init_clamp_logs_conditioning_on_action_number.pt")  
        # # Shared network
