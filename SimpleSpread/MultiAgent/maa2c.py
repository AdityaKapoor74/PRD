...
class MAA2C:
  ...
  def __init__(self,env):
    ...
    self.writer = SummaryWriter('longer_runs/four_agents/simple_spread_2_shared_layers_no_comms_discounted_rewards_lr_2e-4_with_grad_norm_0.5_entropy_pen_0.008_xavier_uniform_init_clamp_logs')
...
#       make a directory called models
      if episode%500:
        torch.save(self.agents.actorcritic.state_dict(), "./models/four_agents/actorcritic_network_no_comms_discounted_rewards_lr_2e-4_with_grad_norm_0.5_entropy_pen_0.008_xavier_uniform_init_clamp_logs.pt")
